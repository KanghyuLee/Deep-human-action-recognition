...
def check_mpii_dataset():
    ...
    try:
        ...
        mpii_path = os.path.join(os.path.dirname(os.path.dirname(os.getcwd())), 'datasets/MPII/')
...
def check_ntu_dataset():
    try:
        ...
        ntu_path = os.path.join(os.path.dirname(os.path.dirname(os.getcwd())) + '/datasets/NTU/')
